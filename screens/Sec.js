...
export default function Sec({ navigation }) {  
    ...
    return (
      <View style={{ flex: 1 }}>
        <DrawerContentScrollView {...props}>
          ...
          >
            <View>
              <Text style={{fontSize: 20,fontWeight: 'bold', color: '#EA1179'}}>Airen Mae Bongcaras</Text>
            </View>
  ...
  return (
    <VStack style={{backgroundColor: '#272829', flex: 1}}>
      <GluestackUIProvider>
          <NavigationContainer >
              <Drawer.Navigator drawerContent={props => <CustomDrawer {...props} />} screenOptions={{headerStyle:{ backgroundColor: 'orange'}, drawerStyle:{backgroundColor: '#ffffff'}}} >
